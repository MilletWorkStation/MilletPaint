...
void QtRuleBar::DrawTicker(QPainter &painter)
{
    ...
    double          lower = m_nLower , upper = m_nUpper; /* Upper and lower limits, in ruler units */
...
void QtRuleBar::DrawPos(QPainter &painter)
{
    ...
    QRect allocation = this->rect();
    double position;
    double lower = m_nLower;
    double upper = m_nUpper;
